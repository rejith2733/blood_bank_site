  ...
  return (
    ...
    {/*************** main content *****************/}
      <div className="py-2 px-3">
        ...
        <h3 className="text-xl font-monoton text-gray-900">Alrepure</h3>
          ...
          <ul className="flex  items-end ">
            ...
            <li className="mx-4">
            <Link to="/DonationList" className="text-gray-800 hover:text-red-500 font-bold hover:underline underline-offset-4 decoration-2 decoration-red-600 py-2 rounded-lg  ">
                INVENTORY
              </Link>
